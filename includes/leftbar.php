...
<li class="has-children">
							...
							<ul class="child-nav">
                                            <li><a href="add-assignment.php"><i class="fa fa-bars"></i> <span>Assignment</span></a></li>                                           
                                        </ul>
                                        <li><a href="attendance/index.php"><i class="fa fa fa-server"></i> <span> Attendance</span></a></li>
